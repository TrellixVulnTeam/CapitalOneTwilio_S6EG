...
training = (os.path.join(os.path.dirname(__file__), 'training.json'))
with open(training, 'r') as fp:
...
def handle_input(number, input_msg, action=None, state_params=None, ask_for=None):
